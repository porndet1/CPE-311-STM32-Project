...
int SheetNote[] = {G,P,G,G,P,D,P,D,D,E,P,E,E,D,D,D,D,P,C,P,C,C,B,P,B,B,A,P,A,A,G,G,G,D,P,D,D,C,P,C,C,B,P,B,B,A,A,A,D,P,D,D,C,P,C,C,B,P,B,B,A,A,A,P,G,P,G,G,D,P,D,D,E,P,E,E,D,D,D,P,C,P,C,C,B,P,B,B,A,P,A,A,G,G,G,G};
	
int i = 0;
int length = sizeof(SheetNote);
  ...
  SystemClock_Config();
	...
	while(1)
	{
		if(LL_TIM_IsActiveFlag_UPDATE(TIM2) == SET)
		{
			...
			//LL_TIM_SetAutoReload(TIM4, P); //Change ARR of Timer PWM
